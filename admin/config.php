<?php
    ...
    define( 'K_DB_NAME', 'drcisst' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'drcisst' );
    // 6.
    // Database password 
    define( 'K_DB_PASSWORD', 'helpingthehelpers' );
    // 7.
    ...
    define( 'K_PAID_LICENSE', 1 );
        ...
        define( 'K_LOGO_LIGHT', 'drcisst-banner.svg' );

        // 99b. Company Logo on dark background  (Max. 171 x 64 pixels. Needs to be placed within 'couch/theme/images/' folder)
        define( 'K_LOGO_DARK', 'drcisst-banner.svg' );

        // 99c. Footer content (Company name and link)
        define( 'K_ADMIN_FOOTER', '<a href="http://www.drcisst.org">©2015 DURHAM REGION CRITICAL INCIDENT STRESS SUPPORT TEAM</a>' );
